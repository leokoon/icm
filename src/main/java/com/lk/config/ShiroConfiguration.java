...
import com.lk.auth.security.shiro.*;
...
public class ShiroConfiguration {
    ...
    public ShiroFilterFactoryBean shirFilter(DefaultWebSecurityManager securityManager){
        ...
        /**
         * anon（匿名）  org.apache.shiro.web.spring.authc.AnonymousFilter
         * authc（身份验证）       org.apache.shiro.web.spring.authc.FormAuthenticationFilter
         * authcBasic（http基本验证）    org.apache.shiro.web.spring.authc.BasicHttpAuthenticationFilter
         * logout（退出）        org.apache.shiro.web.spring.authc.LogoutFilter
         * noSessionCreation（不创建session） org.apache.shiro.web.spring.session.NoSessionCreationFilter
         * perms(许可验证)  org.apache.shiro.web.spring.authz.PermissionsAuthorizationFilter
         * port（端口验证）   org.apache.shiro.web.spring.authz.PortFilter
         * rest  (rest方面)  org.apache.shiro.web.spring.authz.HttpMethodPermissionFilter
         * roles（权限验证）  org.apache.shiro.web.spring.authz.RolesAuthorizationFilter
         * ssl （ssl方面）   org.apache.shiro.web.spring.authz.SslFilter
         * member （用户方面）  org.apache.shiro.web.spring.authc.UserFilter
