...
package com.lk.auth.security.shiro;

import com.lk.auth.domain.*;
...
public class AdminShiroRealm extends AuthorizingRealm {
    ...
    @Resource
    private IUsersRolesRepo usersRolesRepository;
    @Resource
    ...
    protected AuthorizationInfo doGetAuthorizationInfo(PrincipalCollection principals) throws AuthenticationException{
        ...
        */
        ...
        Set<UsersRoles> usersRoles = usersRolesRepository.findByUserId(userInfo.getId());
     ...
     * @return
     */
    public Set<String> getStringCode(Set<Auth> code){
        Set<String> stringPermissions = new HashSet<String>();
        if(code != null){
            for(Auth auth : code) {
                stringPermissions.add(auth.getAuthId());
            }
        }
